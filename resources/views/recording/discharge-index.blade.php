...
<div class="modal fade" id="modal-discharge" data-bs-backdrop="static">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form id="discharge-form" action="{{route('patient.discharge')}}" method="POST">
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group mb-4 d-flex flex-column justify-content-end">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="discharge-lama" id="dailyLabel">Left Against Medical Advice</label>
                                </div>
                                <div class="form-check">
