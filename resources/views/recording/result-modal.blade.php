        ...
        <div class="modal-content">
            ...
            <form id="collect-result-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="small text-inverse text-opacity-50 mb-2"><b class="fw-bold">Inestigation Info</b></div>
                        <div class="col-md-6">

                            <div class="form-group mb-4 d-flex flex-column justify-content-end">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"  id="collectResult" name="lab_id" checked>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="collect-result-save"><div class="spinner-grow spinner-grow-sm" id="collect-result-save-spinner"></div> Save</button>
                </div>
            </form>
