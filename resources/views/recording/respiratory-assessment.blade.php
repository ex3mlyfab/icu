        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="number" class="form-control" name="respiratory_effort" placeholder="Respiratory Effort">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="input-group flex-nowrap">
                                ...
                                <input type="number" class="form-control" name="endothracheal_intubation" placeholder="">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="resp-save"><div class="spinner-grow spinner-grow-sm" id="resp-save-spinner"></div> Save</button>
                </div>
                </form>
